...
const loadPosts = async () => {
  ...
  try {
    const result = await mobileApi.discover.myFavoritedPosts({
...
<template>
  <view class="page">
    <view class="title">{{ copy.myFavoritesTitle }}</view>

    <AsyncStateCard
      v-if="isLoading"
      variant="loading"
      :text="copy.myFavoritesLoading"
    />
