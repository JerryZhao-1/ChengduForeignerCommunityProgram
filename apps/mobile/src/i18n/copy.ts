export const appCopy = {
  zh: {
    ...
    discover: {
      ...
      imageUrlsLabel: "图片 URL",
      imageUrlsPlaceholder: "可选，每行一个图片 URL",
      submitPost: "发布",
      submittingPost: "发布中...",
      titleRequired: "请填写标题",
      contentRequired: "请填写正文",
      tagsRequired: "请至少填写一个标签",
      invalidImageUrl: "图片 URL 格式不正确",
      createSuccess: "帖子已发布",
  ...
  en: {
    ...
    discover: {
      ...
      imageUrlsPlaceholder: "Optional. One image URL per line",
      submitPost: "Publish",
      submittingPost: "Publishing...",
      titleRequired: "Please enter a title",
      contentRequired: "Please enter content",
      tagsRequired: "Please add at least one tag",
      invalidImageUrl: "One or more image URLs are invalid",
