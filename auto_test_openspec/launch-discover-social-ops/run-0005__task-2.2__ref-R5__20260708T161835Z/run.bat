...
echo Starting Mobile H5 for MCP profile validation > "%SCRIPT_DIR%logs\mobile-h5-server.log"
echo URL: http://localhost:5174/#/pages/more/profile?id=user_002 >> "%SCRIPT_DIR%logs\mobile-h5-server.log"
