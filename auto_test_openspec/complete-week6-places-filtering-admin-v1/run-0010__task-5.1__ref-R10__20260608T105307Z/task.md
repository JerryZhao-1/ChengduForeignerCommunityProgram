# Validation Bundle: Update implemented API and plan-facing docs for Week 6 query/media behavior
...
```bash
auto_test_openspec/complete-week6-places-filtering-admin-v1/run-0010__task-5.1__ref-R10__20260608T105307Z/run.sh
```

Windows:

```bat
auto_test_openspec/complete-week6-places-filtering-admin-v1/run-0010__task-5.1__ref-R10__20260608T105307Z/run.bat
```
