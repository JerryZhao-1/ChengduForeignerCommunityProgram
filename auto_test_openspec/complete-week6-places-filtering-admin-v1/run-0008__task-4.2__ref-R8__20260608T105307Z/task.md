# Validation Bundle: Attach place gallery media through the backend files flow
...
```bash
auto_test_openspec/complete-week6-places-filtering-admin-v1/run-0008__task-4.2__ref-R8__20260608T105307Z/run.sh
```

Windows:

```bat
auto_test_openspec/complete-week6-places-filtering-admin-v1/run-0008__task-4.2__ref-R8__20260608T105307Z/run.bat
```
