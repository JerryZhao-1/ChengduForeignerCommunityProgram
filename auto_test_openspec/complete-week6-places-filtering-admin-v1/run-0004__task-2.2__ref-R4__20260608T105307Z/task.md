# Validation Bundle: Preserve recommendation query and published visibility behavior while adding tag support
...
```bash
auto_test_openspec/complete-week6-places-filtering-admin-v1/run-0004__task-2.2__ref-R4__20260608T105307Z/run.sh
```

Windows:

```bat
auto_test_openspec/complete-week6-places-filtering-admin-v1/run-0004__task-2.2__ref-R4__20260608T105307Z/run.bat
```
