# Validation Bundle: Keep shared category taxonomy as the mobile/admin filter truth
...
```bash
auto_test_openspec/complete-week6-places-filtering-admin-v1/run-0002__task-1.2__ref-R2__20260608T105307Z/run.sh
```

Windows:

```bat
auto_test_openspec/complete-week6-places-filtering-admin-v1/run-0002__task-1.2__ref-R2__20260608T105307Z/run.bat
```
