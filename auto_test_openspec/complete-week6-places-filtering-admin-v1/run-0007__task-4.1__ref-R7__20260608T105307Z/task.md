# Validation Bundle: Complete admin places v1 create/edit metadata maintenance
...
```bash
auto_test_openspec/complete-week6-places-filtering-admin-v1/run-0007__task-4.1__ref-R7__20260608T105307Z/run.sh
```

Windows:

```bat
auto_test_openspec/complete-week6-places-filtering-admin-v1/run-0007__task-4.1__ref-R7__20260608T105307Z/run.bat
```
