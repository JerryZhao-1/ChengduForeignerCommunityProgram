# Validation Bundle: Run final Week 6 validation and record evidence
...
```bash
auto_test_openspec/complete-week6-places-filtering-admin-v1/run-0011__task-5.2__ref-R11__20260608T105307Z/run.sh
```

Windows:

```bat
auto_test_openspec/complete-week6-places-filtering-admin-v1/run-0011__task-5.2__ref-R11__20260608T105307Z/run.bat
```
...
- `openspec validate complete-week6-places-filtering-admin-v1 --strict --no-interactive`
- `corepack pnpm vitest run packages/shared/test/contracts.spec.ts packages/shared/test/client.spec.ts apps/mobile/src/pages/places/list-categories.spec.ts apps/api/test/app.spec.ts apps/api/test/cloudbase.spec.ts`
