...
set PUBLIC_LAUNCH_EVIDENCE_FILE=%SCRIPT_DIR%inputs\evidence-collector.json
node scripts/public_launch_verify.mjs evidence-collector > "%SCRIPT_DIR%logs\run.log" 2>&1
