...
```bash
auto_test_openspec/complete-june22-june23-release-readiness/run-0001__task-1.1__ref-R1__20260624T000000Z/run.sh
```

Windows:

```bat
auto_test_openspec\complete-june22-june23-release-readiness\run-0001__task-1.1__ref-R1__20260624T000000Z\run.bat
```
