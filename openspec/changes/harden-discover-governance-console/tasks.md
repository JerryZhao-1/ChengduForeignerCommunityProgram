...
- [x] 1.1 Add report case, moderation, user enforcement, and audit schemas/contracts [#R1]
...
- [x] 1.2 Implement admin discover governance API routes and providers [#R2]
...
- [x] 1.3 Implement report evidence upload and protected access [#R3]
...
- [x] 2.1 Replace admin posts skeleton with moderation queues and filters [#R4]
...
- [x] 2.2 Add post/comment/report detail drawers and batch actions [#R5]
...
- [x] 2.3 Add user governance workflow [#R6]
...
- [x] 3.1 Update docs and run strict validation [#R7]
