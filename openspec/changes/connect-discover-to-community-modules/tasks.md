...
- [ ] 1.1 Extend discover post inputs and payloads for place/event associations [#R1]
...
- [ ] 1.2 Add provider validation for associated places and events [#R2]
...
- [ ] 1.3 Add related discover queries for places and events [#R3]
...
- [ ] 2.1 Add place/event selection and cards to discover create/detail [#R4]
...
- [ ] 2.2 Add related discover sections to place and event detail [#R5]
...
- [ ] 2.3 Replace hardcoded discover author data with profile-backed summaries [#R6]
...
- [ ] 3.1 Add discover-triggered notification events [#R7]
...
- [ ] 3.2 Update docs and run strict validation [#R8]
