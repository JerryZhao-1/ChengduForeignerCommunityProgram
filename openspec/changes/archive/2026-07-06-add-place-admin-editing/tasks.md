...
- [x] 1.1 Finalize the shared admin place update contract [#R1]
...
- [x] 1.2 Harden admin PATCH route and CloudBase HTTP handler behavior [#R2]
...
- [x] 2.1 Align mock provider partial update semantics [#R3]
...
- [x] 2.2 Align CloudBase provider update persistence [#R4]
...
- [x] 3.1 Add backend regression coverage for edited place visibility [#R5]
...
- [x] 3.2 Update API documentation and run final validation [#R6]
