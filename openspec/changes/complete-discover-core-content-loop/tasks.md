...
- [x] 1.1 Extend discover schemas, contracts, paths, clients, and fixtures [#R1]
...
- [x] 1.2 Add API routes and provider methods for comments and my posts [#R2]
...
- [x] 1.3 Implement post media upload and binding [#R3]
...
- [x] 1.4 Implement CloudBase live discover core provider [#R4]
...
- [x] 2.1 Replace hardcoded detail comments with API-backed comment reads [#R5]
...
- [x] 2.2 Replace URL-only post creation with media picker upload flow [#R6]
...
- [x] 2.3 Implement API-backed my-posts page [#R7]
...
- [x] 3.1 Update docs and run strict validation [#R8]
