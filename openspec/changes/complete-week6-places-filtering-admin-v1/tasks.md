...
- [ ] 1.1 Add `tag` to the v1 public places list query contract [#R1]
...
- [ ] 1.2 Keep shared category taxonomy as the mobile/admin filter truth [#R2]
...
- [ ] 2.1 Implement aligned public list tag filtering across provider paths [#R3]
...
- [ ] 2.2 Preserve recommendation query and published visibility behavior while adding tag support [#R4]
...
- [ ] 3.1 Complete mobile list category, tag, keyword, and recommended filter flows [#R5]
...
- [ ] 3.2 Keep recommended places as a filtered list entry flow [#R6]
...
- [ ] 4.1 Complete admin places v1 create/edit metadata maintenance [#R7]
...
- [ ] 4.2 Attach place gallery media through the backend files flow [#R8]
...
- [ ] 4.3 Verify attached gallery files resolve to mobile-displayable detail media [#R9]
...
- [ ] 5.1 Update implemented API and plan-facing docs for Week 6 query/media behavior [#R10]
...
- [ ] 5.2 Run final Week 6 validation and record evidence [#R11]
